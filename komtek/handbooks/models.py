...
class Handbook(models.Model):
    ...
    id = models.UUIDField(
        "Идентификатор", primary_key=True, editable=False, default=uuid.uuid4
    )
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["handbook", "version"], name="unique_version"
            ),
            models.UniqueConstraint(
                fields=["handbook", "date_start"], name="unique_data"
            ),
        ]
